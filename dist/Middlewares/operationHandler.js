...
const adjustStock = (filter, qtyChange, montantChange) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (qtyChange < 0) {
      const res = yield model_1.Stock.findOneAndUpdate(
        Object.assign(Object.assign({}, filter), {
          quantite: { $gte: Math.abs(qtyChange) },
        }),
      ...
      try {
        ...
        if (type === "Livraison") {
          ...
          if (!srcStock || srcStock.quantite < quantite) {
            return next(
              new Error("Stock source insuffisant pour la livraison"),
            );
          }
          // *** FIX demandé ***
          ...
          if (hadRegionAndPV) {
            ...
            (_b = (_a = this).set) === null || _b === void 0
              ? void 0
              : _b.call(_a, "region", undefined);
  ...
  MouvementStockSchema.post("save", function (doc) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (type === "Entrée") {
          if (doc.region)
            yield (0, exports.adjustStock)(
              { produit, region: doc.region },
              quantite,
              montant,
            );
          else
