...
exports.getDefaultOrganisationLogo = exports.deleteOrganisation = exports.updateOrganisation = exports.createOrganisation = exports.getOrganisationById = exports.getAllOrganisations = void 0;
...
const getAllOrganisations = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const organisations = yield model_1.Organisations.find().populate("superAdmin");
...
const getOrganisationById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const organisation = yield model_1.Organisations.findById(id).populate("superAdmin");
        if (!organisation) {
...
const createOrganisation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { nom, idNat, contact, numeroImpot, devise, superAdmin, pays, emailEntreprise, } = req.body;
        let logoUrl = "";
        // Upload du logo si présent
        if (req.file) {
            try {
                logoUrl = yield (0, uploadService_1.uploadFile)(req.file, "organisations");
            }
            catch (uploadError) {
...
const updateOrganisation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (req.file) {
            try {
                const logoUrl = yield (0, uploadService_1.uploadFile)(req.file, "organisations");
                updateData.logo = logoUrl;
                // Optionnel: Supprimer l'ancien logo
                const oldOrg = yield model_1.Organisations.findById(id);
                if ((oldOrg === null || oldOrg === void 0 ? void 0 : oldOrg.logo) && process.env.NODE_ENV !== "development") {
        ...
        const updated = yield model_1.Organisations.findByIdAndUpdate(id, updateData, {
            new: true,
            runValidators: true,
        }).populate("superAdmin");
        if (!updated) {
...
const getDefaultOrganisationLogo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const organisation = yield model_1.Organisations.findOne().sort({ _id: 1 });
        if (!organisation) {
