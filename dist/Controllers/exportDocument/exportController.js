    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const exportData = data.map((row, index) => {
            ...
            const prix = ["Entrée", "Livraison", "Commande"].includes(row.type)
                ? ((_a = produit.prix) !== null && _a !== void 0 ? _a : 0)
                : ((_b = produit.prixVente) !== null && _b !== void 0 ? _b : 0);
            const prixVente = (_c = produit.prixVente) !== null && _c !== void 0 ? _c : 0;
            ...
            return {
                ...
                "Point de Vente": ((_h = row.pointVente) === null || _h === void 0 ? void 0 : _h.nom) || "",
                Operation: row.type,
                Quantité: quantite,
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const exportData = data.map((row, index) => {
            ...
            return {
                ...
                Catégorie: categorie.nom || "",
                Quantité: quantite,
                Montant: ((_g = row.montant) === null || _g === void 0 ? void 0 : _g.toFixed(2)) || "0.00",
                ...
                "Point de Vente": ((_h = row.pointVente) === null || _h === void 0 ? void 0 : _h.nom) || "Depot Central",
                "Créé le": new Date(row.createdAt).toLocaleDateString(),
            };
        });
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const exportData = data.map((row, index) => {
            ...
            return {
                ...
                Région: ((_a = row.region) === null || _a === void 0 ? void 0 : _a.nom) || ((_c = (_b = row.pointVente) === null || _b === void 0 ? void 0 : _b.region) === null || _c === void 0 ? void 0 : _c.nom) || "Depot Central",
                "Point de Vente": ((_d = row.pointVente) === null || _d === void 0 ? void 0 : _d.nom) || "Depot Central",
                Rôle: row.role || "",
                "Créé le": new Date(row.createdAt).toLocaleDateString(),
            };
        });
...
function exportPointVenteHandler(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const exportData = data.map((row, index) => {
            ...
            return {
                "#": index + 1,
                Région: ((_a = row.region) === null || _a === void 0 ? void 0 : _a.nom) || "N/A",
                Nom: row.nom || "",
                Adresse: row.adresse || "",
                "Créé le": new Date(row.createdAt).toLocaleDateString(),
            };
