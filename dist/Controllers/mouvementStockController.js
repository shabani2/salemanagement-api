...
exports.livrerProduitCommande =
  ...
  exports.getMouvementStockByIdPage =
    ...
    try {
      ...
      const mouvementsFiltres = mouvements.filter((m) => {
        ...
        return (
          ((_c =
            (_b =
              (_a = m.pointVente) === null || _a === void 0
                ? void 0
          ...
          ((_e =
            (_d = m.region) === null || _d === void 0 ? void 0 : _d._id) ===
            null || _e === void 0
            ? void 0
...
const updateMouvementStock = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (pointVente)
        updateData.pointVente = new mongoose_1.default.Types.ObjectId(
          pointVente,
        );
      if (region)
      ...
      const updated = yield model_1.MouvementStock.findByIdAndUpdate(
        id,
        updateData,
        {
          new: true,
...
const validateState = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
      const mouvement = yield model_1.MouvementStock.findByIdAndUpdate(
        id,
        { statut: true },
        { new: true },
      )
...
const getMouvementsStockAggregatedByPointVente = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      console.error(
        "Erreur dans getMouvementsStockAggregatedByPointVente:",
        err,
      );
      res.status(500).json({ message: "Erreur interne", error: err });
      return;
...
const getMouvementStockByIdPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
      const mouvement = yield model_1.MouvementStock.findById(id)
...
const getMouvementsStockByRegionOptimizedPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { regionId } = req.params;
      const page = parseInt(req.query.page) || 1;
...
exports.getMouvementsStockByRegionOptimizedPage =
  getMouvementsStockByRegionOptimizedPage;
