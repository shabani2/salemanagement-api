...
exports.livrerProduitCommande =
  ...
  exports.getMouvementsStockAggregatedByUserId =
  exports.validateState =
  exports.deleteMouvementStock =
  exports.updateMouvementStock =
  exports.createMouvementStock =
  exports.getMouvementsStockByUserId =
  exports.getMouvementStockByRegion =
  exports.getMouvementsStockByPointVenteId =
  exports.getMouvementsStockByPointVente =
  exports.getMouvementStockById =
  exports.getMouvementsStockByPointVentePage =
  exports.getMouvementStockByRegionPage =
  exports.getAllMouvementsStock =
  exports.getAllMouvementsStockPage =
    void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const model_1 = require("../Models/model");
const toObjectId = (v) => new mongoose_1.default.Types.ObjectId(String(v));
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const userRegionId =
      typeof user.region === "string"
        ? user.region
        : (_a = user === null || user === void 0 ? void 0 : user.region) ===
              null || _a === void 0
          ? void 0
          : _a._id;
    if (
...
// GET /mouvements/page
const getAllMouvementsStockPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      let match = Object.assign({}, baseMatch);
      if (match.region && !match.pointVente && !onlyRegion) {
        ...
        if (regionOID) {
          ...
          const pvIds = (yield model_1.PointVente.distinct("_id", {
            region: regionOID,
          }))
            .map((id) => toId(id))
            .filter(Boolean);
          ...
          const { region } = match,
            rest = __rest(match, ["region"]);
          const or = [{ region: regionOID }];
          if (pvIds.length) or.push({ pointVente: { $in: pvIds } });
          match = Object.assign(Object.assign({}, rest), { $or: or });
        }
      }
      // 2) stratégie
            ...
            (_e =
              (_d =
                (_c =
                  ...
                  null || _c === void 0
                  ? void 0
                  : _c.metadata) === null || _d === void 0
                ? void 0
                : _d[0]) === null || _e === void 0
              ? void 0
              : _e.total) !== null && _f !== void 0
            ? _f
            : 0;
      ...
      const mouvements = yield populateAll(
        model_1.MouvementStock.find(match)
          .sort({ [sortBy]: order })
          .skip(skip)
          .limit(limit),
      );
      ...
      const status =
        (_g = err === null || err === void 0 ? void 0 : err.status) !== null &&
        _g !== void 0
          ? _g
          : 500;
...
const getAllMouvementsStock = (req, res) =>
...
const getMouvementStockByRegionPage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
      ...
      const status =
        (_a = err === null || err === void 0 ? void 0 : err.status) !== null &&
        _a !== void 0
          ? _a
          : 500;
      res.status(status).json({
...
const getMouvementsStockByPointVentePage = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
...
const toId = (v) => {
  ...
  return v
    ? new mongoose_1.default.Types.ObjectId(
        String(
          (_a = v === null || v === void 0 ? void 0 : v._id) !== null &&
            _a !== void 0
            ? _a
            : v,
        ),
...
const isSuperAdmin = (req) => {
  ...
  return (
    String(
      (_b = (_a = req.user) === null || _a === void 0 ? void 0 : _a.role) !==
        null && _b !== void 0
        ? _b
        : "",
...
const getUserIds = (req) => {
  ...
  return {
    ...
    pvId: toId(
      (_b = req.user) === null || _b === void 0 ? void 0 : _b.pointVente,
    ),
...
function applyBusinessFilters(base, req) {
  ...
  if (dateFrom || dateTo) {
    out.createdAt = {};
    if (dateFrom && !Number.isNaN(+dateFrom)) out.createdAt.$gte = dateFrom;
    if (dateTo && !Number.isNaN(+dateTo)) out.createdAt.$lte = dateTo;
  }
  return out;
}
/** Populate commun */
...
function assertCanAccessPointVente(req, pointVenteId) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const userPV = toId(
      (_a = req.user) === null || _a === void 0 ? void 0 : _a.pointVente,
    );
    const userRG = toId(
...
/* -------------------------------------------------------------------------- */
/*                                   ROUTES                                   */
const getMouvementStockById = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    try {
      const { id } = req.params;
      ...
      if (
        ...
        !(
          (scope.pointVente &&
            String(scope.pointVente) ===
              String(
                (_a = mv.pointVente) === null || _a === void 0
                  ? void 0
                  : _a._id,
              )) ||
          (scope.region &&
            String(scope.region) ===
              String(
                (_b = mv.region) === null || _b === void 0 ? void 0 : _b._id,
              )) ||
          (scope.user &&
            String(scope.user) ===
              String(
                (_c = mv.user) === null || _c === void 0 ? void 0 : _c._id,
              ))
        )
      ) {
...
const getMouvementsStockByPointVente = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
      const { pointVenteId } = req.params;
      ...
      res
        .status(
          (_a = err === null || err === void 0 ? void 0 : err.status) !==
            null && _a !== void 0
            ? _a
            : 500,
        )
...
const getMouvementsStockByPointVenteId = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
      const { pointVenteId } = req.params;
...
const getMouvementStockByRegion = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    try {
      const { regionId } = req.params;
      ...
      const page = Math.max(
        parseInt(
          String((_a = req.query.page) !== null && _a !== void 0 ? _a : "1"),
          10,
        ) || 1,
        1,
      );
      const limit = Math.min(
        Math.max(
          parseInt(
            String(
              (_b = req.query.limit) !== null && _b !== void 0 ? _b : "20",
            ),
            10,
          ) || 20,
          1,
      ...
      if (req.query.produit) {
        ...
        if (mongoose_1.default.isValidObjectId(pid))
          baseFilter.produit = toObjectId(pid);
      }
      const createdAt = {};
      ...
      const rawPvIds = yield model_1.PointVente.distinct("_id", {
        region: regionOID,
      });
      const pvIds = rawPvIds.map((id) => toObjectId(String(id)));
      ...
      if (
        ...
        mongoose_1.default.isValidObjectId(String(req.query.pointVente))
      ) {
        pvMatchClause = {
          pointVente: toObjectId(String(req.query.pointVente)),
        };
      }
      const finalFilter = {
        $and: [baseFilter, regionOrPVFilter, pvMatchClause],
      };
      ...
      res
        .status(
          (_c = err === null || err === void 0 ? void 0 : err.status) !==
            null && _c !== void 0
            ? _c
            : 500,
        )
        .json({
          message:
            (_d = err === null || err === void 0 ? void 0 : err.message) !==
              null && _d !== void 0
              ? _d
              : "Erreur interne",
        });
...
/* ----------------------------------- USER --------------------------------- */
// GET "/byUser/:userId"
const getMouvementsStockByUserId = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
...
/* ----------------------------- CREATE / UPDATE ---------------------------- */
// POST "/"
const createMouvementStock = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
      const {
      ...
      const populated = yield populateAll(
        model_1.MouvementStock.findById(mouvement._id),
      );
...
// PUT "/:id"
const updateMouvementStock = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
      const { id } = req.params;
      ...
      const updated = yield populateAll(
        model_1.MouvementStock.findByIdAndUpdate(id, updateData, { new: true }),
      );
      if (!updated) {
        res.status(404).json({ message: "Mouvement non trouvé" });
        return;
...
// DELETE "/:id"
const deleteMouvementStock = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
...
// PUT "/validate/:id"
const validateState = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
      const mouvement = yield populateAll(
        model_1.MouvementStock.findByIdAndUpdate(
          id,
          { statut: true },
          { new: true },
        ),
...
const getMouvementsStockAggregatedByUserId = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
      const { userId } = req.params;
      ...
      const result =
        yield model_1.MouvementStock.aggregate(aggregationPipeline);
      const data =
        ((_a = result[0]) === null || _a === void 0 ? void 0 : _a.data) || [];
      const metadata =
        ((_b = result[0]) === null || _b === void 0 ? void 0 : _b.metadata) ||
        [];
      ...
      const populatedData = yield Promise.all(
        data.map((item) =>
          __awaiter(void 0, void 0, void 0, function* () {
            const populatedProduit = yield model_1.Produit.findById(
              item.produit,
            ).populate({
              path: "categorie",
              model: "Categorie",
      ...
      const sortedData = populatedData.sort((a, b) => {
        var _a, _b;
        const nomA =
          ((_a = a.produit) === null || _a === void 0 ? void 0 : _a.nom) || "";
        const nomB =
          ((_b = b.produit) === null || _b === void 0 ? void 0 : _b.nom) || "";
...
const getMouvementsStockAggregatedByPointVente = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
      const { pointVenteId } = req.params;
...
const livrerProduitCommande = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const {
        commandeId,
      ...
      if (!commandeId || !produit || !quantite || !montant || !user) {
        res.status(400).json({
          message:
            "commandeId, produit, quantite, montant et user sont requis.",
        });
        return;
      }
      ...
      if (pointVente)
        mouvementData.pointVente = new mongoose_1.default.Types.ObjectId(
          pointVente,
        );
      if (region)
      ...
      const populatedMouvement = yield model_1.MouvementStock.findById(
        mouvement._id,
      )
        .populate("produit")
        .populate("commandeId")
