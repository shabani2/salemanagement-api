...
const getAllRegions = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const ville =
        (_b = req.query.ville) === null || _b === void 0 ? void 0 : _b.trim();
      const sortBy = req.query.sortBy || "createdAt";
      const order = req.query.order === "asc" ? 1 : -1;
      const includeTotal =
        ((_c = req.query.includeTotal) !== null && _c !== void 0
          ? _c
          : "true") === "true";
...
const updateRegion = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
      const { nom, ville } = req.body;
      const updated = yield model_1.Region.findByIdAndUpdate(
        id,
        { nom, ville },
