...
const getUsersByRegion = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const filteredUsers = users.filter((user) => {
            var _a, _b, _c, _d;
            return ((_b = (_a = user.region) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.toString()) === regionId ||
                (user.pointVente &&
                    ((_d = (_c = user.pointVente.region) === null || _c === void 0 ? void 0 : _c._id) === null || _d === void 0 ? void 0 : _d.toString()) === regionId);
        });
