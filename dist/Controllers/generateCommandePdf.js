...
const kvLine = (doc, label, value, x, width, font, fontSize, gap = 4) => {
    ...
    const dotsCount = Math.max(0, Math.floor((width - labelW - valueW - gap * 2) / dotW));
...
function resolvePage(formatName, itemsCount = 0) {
    ...
    if (f === "a5")
        return { size: "A5", margins: 24, isPOS: false };
    return { size: "A4", margins: 28, isPOS: false };
}
/* ------------------------------ RENDER PDF ------------------------------ */
function renderCommandePdf(res_1, payload_1) {
    return __awaiter(this, arguments, void 0, function* (res, payload, options = {}) {
        var _a, _b, _c, _d;
        const { organisation, format = "pos80" } = options;
        const commande = payload;
        const produits = Array.isArray(commande === null || commande === void 0 ? void 0 : commande.produits) ? commande.produits : [];
        ...
        doc.on("end", () => {
            ...
            res.setHeader("Content-Disposition", `attachment; filename=Bon_de_commande.pdf`);
            res.send(result);
        });
        // Styles
        const FS = {
        ...
        doc
            .font("Helvetica-Bold")
            .fontSize(FS.bold)
            .text((organisation === null || organisation === void 0 ? void 0 : organisation.nom) || "—", orgX, y, {
            width: pageWidth - (orgX - x0),
        });
        doc.font("Helvetica").fontSize(FS.small).fillColor("#444");
        const infosOrg = [
            (organisation === null || organisation === void 0 ? void 0 : organisation.rccm) ? `RCCM : ${organisation.rccm}` : "",
            (organisation === null || organisation === void 0 ? void 0 : organisation.contact) ? `Contact : ${organisation.contact}` : "",
            (organisation === null || organisation === void 0 ? void 0 : organisation.siegeSocial) ? `Adresse : ${organisation.siegeSocial}` : "",
            (organisation === null || organisation === void 0 ? void 0 : organisation.pays) ? `Pays : ${organisation.pays}` : "",
        ].filter(Boolean);
        let oy = doc.y + 2;
        infosOrg.forEach((ln) => {
        ...
        y = doc.y + GAP.sub;
        doc.y = y;
        kvLine(doc, "N° commande", String((commande === null || commande === void 0 ? void 0 : commande.numero) || "—"), x0, pageWidth, "Helvetica", FS.body);
        doc.y += GAP.line;
        kvLine(doc, "Date", (0, date_fns_1.format)(new Date((commande === null || commande === void 0 ? void 0 : commande.createdAt) || Date.now()), "dd/MM/yyyy HH:mm"), x0, pageWidth, "Helvetica", FS.body);
        doc.y += GAP.line;
        kvLine(doc, "Statut", String((commande === null || commande === void 0 ? void 0 : commande.statut) || "attente"), x0, pageWidth, "Helvetica", FS.body);
        doc.y += GAP.line;
        kvLine(doc, "Utilisateur", String(((_a = commande === null || commande === void 0 ? void 0 : commande.user) === null || _a === void 0 ? void 0 : _a.nom) || ((_b = commande === null || commande === void 0 ? void 0 : commande.user) === null || _b === void 0 ? void 0 : _b._id) || "—"), x0, pageWidth, "Helvetica", FS.body);
        doc.y += GAP.line;
        // Destination (region / pointVente / dépôt central)
        if ((_c = commande === null || commande === void 0 ? void 0 : commande.pointVente) === null || _c === void 0 ? void 0 : _c.nom) {
            kvLine(doc, "Point de vente", String(commande.pointVente.nom), x0, pageWidth, "Helvetica", FS.body);
            doc.y += GAP.line;
        }
        else if ((_d = commande === null || commande === void 0 ? void 0 : commande.region) === null || _d === void 0 ? void 0 : _d.nom) {
            kvLine(doc, "Région", String(commande.region.nom), x0, pageWidth, "Helvetica", FS.body);
            doc.y += GAP.line;
        }
        if ((commande === null || commande === void 0 ? void 0 : commande.depotCentral) === true) {
        ...
        for (const cp of produits) {
            ...
            const qte = Number((cp === null || cp === void 0 ? void 0 : cp.quantite) || 0);
            const statut = String((cp === null || cp === void 0 ? void 0 : cp.statut) || "attente");
        ...
        doc.moveDown(0.6);
        kvLine(doc, "Nombre de lignes", String(totalLignes), x0, pageWidth, "Helvetica", FS.body);
        doc.y += GAP.line;
        kvLine(doc, "Quantité totale", String(totalQuantites), x0, pageWidth, "Helvetica-Bold", FS.body);
        doc.y += GAP.line;
        /* ------------------------------- NOTES -------------------------------- */
