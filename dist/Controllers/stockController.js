...
const getStocksByRegion = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const qPv = (_a = req.query.pointVente) === null || _a === void 0 ? void 0 : _a.trim();
        const pvFilterId = qPv && mongoose_1.Types.ObjectId.isValid(qPv)
...
const checkStockHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const depotCentral = req.body.depotCentral === true ||
    ...
    try {
        const quantiteDisponible = yield (0, exports.checkStock)({
            ...
            pointVenteId: scope === null || scope === void 0 ? void 0 : scope.pointVenteId,
            depotCentral: !!(scope === null || scope === void 0 ? void 0 : scope.depotCentral),
        });
        res.json({
            success: true,
            quantiteDisponible,
