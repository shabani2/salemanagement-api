...
exports.printCommande = exports.deleteCommande = exports.updateCommande = exports.createCommande = exports.getCommandeById = exports.getCommandesByRegion = exports.getCommandesByPointVente = exports.getCommandesByUser = exports.getAllCommandes = void 0;
...
const createCommande = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { user, region, pointVente, depotCentral, produits, organisation, print, } = req.body;
...
const printCommande = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const { id } = req.params;
        ...
        const organisation = ((_a = req.body) === null || _a === void 0 ? void 0 : _a.organisation) || null;
        yield (0, generateCommandePdf_1.renderCommandePdf)(res, commande, { organisation, format });
    }
    catch (error) {
        res.status(500).json({
