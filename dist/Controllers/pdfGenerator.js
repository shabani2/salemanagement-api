...
const generateStockPdf = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e;
    try {
        const { organisation, user, mouvements, type, destinateur, serie, pointVente, paiement, // Ajoutez ce champ dans le body pour afficher mode et montant
        ...
        doc
            ...
            .font("Helvetica")
            .fontSize(9);
        doc.text(`Date : ${(0, date_fns_1.format)(new Date(), "dd/MM/yyyy HH:mm")}`, {
            align: "right",
        });
        ...
        doc.text(`${(_a = user.adresse) !== null && _a !== void 0 ? _a : ""}`, 24);
        if (destinateur) {
            doc.moveDown(0.5);
            doc.font("Helvetica-Bold").text("Destinataire :", 300, doc.y - 30);
            doc.font("Helvetica").fontSize(9);
            doc.text(`${destinateur.nom}`, 300);
            doc.text(`${(_b = destinateur.adresse) !== null && _b !== void 0 ? _b : ""}`, 300);
        }
        if (type === "Commande" && pointVente) {
            ...
            doc.text(`${(_c = pointVente.adresse) !== null && _c !== void 0 ? _c : ""}`, 24);
        }
        ...
        const [nomProduitX, prixUnitaireX, quantiteX, montantX, margeX, tvaX, ttcX,] = Array.from({ length: colCount }, (_, i) => xStart + i * colWidth);
        doc
            .font("Helvetica-Bold")
        ...
        for (const m of mouvements) {
            ...
            const marge = (_d = produit === null || produit === void 0 ? void 0 : produit.marge) !== null && _d !== void 0 ? _d : 0;
            const tva = (_e = produit === null || produit === void 0 ? void 0 : produit.tva) !== null && _e !== void 0 ? _e : 0;
