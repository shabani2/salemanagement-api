...
const money = (n, currency = "FC") => `${(Number(n) || 0).toFixed(2)} ${currency}`;
...
const kvLine = (doc, label, value, x, width, styles, gap = 4) => {
    ...
    const dotsCount = Math.max(0, Math.floor((width - labelWidth - valueWidth - gap * 2) / dotWidth));
...
/* --------------------------------- Main --------------------------------- */
const generateStockPdf = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { organisation, user, mouvements, type, destinateur, serie, pointVente, paiement, remarques, format: wantedFormat, currencySymbol, } = req.body;
        ...
        const seriePart = /^\d+$/.test(serie)
            ...
            : String((user === null || user === void 0 ? void 0 : user.id) || "0000")
                .slice(-4)
                .padStart(4, "0");
        ...
        const { size, margins, isPOS } = resolvePage(wantedFormat, (mouvements === null || mouvements === void 0 ? void 0 : mouvements.length) || 0);
        ...
        if ((organisation === null || organisation === void 0 ? void 0 : organisation.idNat) || (organisation === null || organisation === void 0 ? void 0 : organisation.numeroImpot)) {
            const bx = x0;
            const bw = pageWidth;
        ...
        kvLine(doc, "Date", (0, date_fns_1.format)(new Date(), "dd/MM/yyyy HH:mm"), x0, pageWidth, {
            font: "Helvetica",
            fontSize: FS.body,
        });
        y = doc.y + GAP.line;
        ...
        y = doc.y + GAP.line;
        doc.y = y;
        kvLine(doc, "Utilisateur", String((user === null || user === void 0 ? void 0 : user.nom) || (user === null || user === void 0 ? void 0 : user.id) || "—"), x0, pageWidth, { font: "Helvetica", fontSize: FS.body });
        y = doc.y;
        if (pointVente === null || pointVente === void 0 ? void 0 : pointVente.nom) {
            y += GAP.line;
            doc.y = y;
        ...
        if (destinateur === null || destinateur === void 0 ? void 0 : destinateur.nom) {
            y += GAP.line;
            doc.y = y;
        ...
        y += GAP.subBlock;
        doc.y = y;
        let total = 0, totalTVA = 0, totalMarge = 0, totalHt = 0;
        const rowAdvance = isPOS ? 18 : 20;
        for (const m of mouvements || []) {
            ensureSpace(doc, rowAdvance + GAP.line, margins, isPOS);
            const produit = allProduits.find((p) => String(p._id) === String(m.produit));
            const marge = Number((produit === null || produit === void 0 ? void 0 : produit.marge) || 0);
            const tva = Number((produit === null || produit === void 0 ? void 0 : produit.tva) || 0);
            const nomProduit = (produit === null || produit === void 0 ? void 0 : produit.nom) || "-";
            const qte = Number((m === null || m === void 0 ? void 0 : m.quantite) || 0);
            const montant = Number((m === null || m === void 0 ? void 0 : m.montant) || 0);
            ...
            if (showTVA) {
                if (marge)
                    details.push(`Marge ${marge}%`);
                if (tva)
                    details.push(`TVA ${tva}%`);
            }
        ...
        y = doc.y + GAP.line;
        doc.text("Conservez ce ticket comme preuve d'achat. Conditions et retours disponibles sur demande.", x0, y, { width: pageWidth, align: "center" });
        doc.fillColor("black");
