...
const getAllCurrencies = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const currencies = yield CurrencyModel_1.Currency.find().sort({
        createdAt: -1,
      });
      res.json(currencies);
    } catch (err) {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const filter = re
        ...
        : {};
      const currencies = yield CurrencyModel_1.Currency.find(filter).sort({
        createdAt: -1,
      });
      res.json(currencies);
    } catch (err) {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (existing) {
        res
          .status(400)
          .json({ message: "Une devise avec ce code existe déjà" });
        return;
      }
      if (isBase) {
        // Assurer unicité de la devise de base
        yield CurrencyModel_1.Currency.updateMany(
          { isBase: true },
          { $set: { isBase: false } },
        );
      }
...
const updateCurrency = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const updated = yield CurrencyModel_1.Currency.findByIdAndUpdate(
        id,
        updateData,
        {
          new: true,
...
const getBaseCurrency = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const baseCurrency = yield CurrencyModel_1.Currency.findOne({
        isBase: true,
      });
      if (!baseCurrency) {
...
const getAllDiscounts = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const discounts = yield CurrencyModel_1.Discount.find(filter).sort({
        createdAt: -1,
      });
      res.json(discounts);
    } catch (err) {
...
const getFinancialSettings = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const updateFinancialSettings = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
      const updated = yield CurrencyModel_1.FinancialSettings.findOneAndUpdate(
        {},
        req.body,
        {
          new: true,
