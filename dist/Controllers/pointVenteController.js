...
exports.updatePointVente = exports.getPointVenteById = exports.deletePointVente = exports.createPointVente = exports.getPointVentesByRegion = exports.searchPointVentes = exports.getAllPointVentes = void 0;
...
const getAllPointVentes = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const includeTotal = ((_a = req.query.includeTotal) !== null && _a !== void 0 ? _a : "true") === "true";
        ...
        if (includeTotal) {
            ...
            const data = (_c = (_b = agg === null || agg === void 0 ? void 0 : agg[0]) === null || _b === void 0 ? void 0 : _b.data) !== null && _c !== void 0 ? _c : [];
            const total = (_e = (_d = agg === null || agg === void 0 ? void 0 : agg[0]) === null || _d === void 0 ? void 0 : _d.total) !== null && _e !== void 0 ? _e : 0;
...
const getPointVenteById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const { id } = req.params;
        const includeStock = ((_a = req.query.includeStock) !== null && _a !== void 0 ? _a : "true") === "true";
