...
exports.updateCommandeProduit =
  exports.deleteCommande =
  exports.createCommande =
  exports.getCommandeById =
  exports.getCommandeProduitsByRegion =
  exports.getCommandeProduitsByPointVente =
  exports.getCommandeProduitsByUser =
    void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const model_1 = require("../Models/model");
const getCommandeProduitsByUser = (req, res) =>
...
const getCommandeProduitsByPointVente = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getCommandeProduitsByRegion = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (
        ...
        res
          .status(400)
          .json({ message: "Utilisateur et produits sont requis." });
      }
      ...
      const commandeProduits = yield model_1.CommandeProduit.insertMany(
        produitsInput.map((p) => ({
...
const updateCommandeProduit = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    ...
    try {
      const updated = yield model_1.CommandeProduit.findByIdAndUpdate(
        id,
        Object.assign(
          Object.assign(
            Object.assign(
              Object.assign({}, produit && { produit }),
