...
pointVenteRoutes.post(
  ...
  pointVenteController_1.createPointVente,
);
pointVenteRoutes.get(
  "/region/:regionId",
  auth_1.authenticate,
  pointVenteController_1.getPointVentesByRegion,
);
pointVenteRoutes.delete(
  "/:id",
  auth_1.authenticate,
  (0, authorize_1.authorize)(["SuperAdmin", "AdminRegion"]),
  pointVenteController_1.deletePointVente,
);
pointVenteRoutes.get(
  "/:id",
  auth_1.authenticate,
  pointVenteController_1.getPointVenteById,
);
pointVenteRoutes.put(
  "/:id",
  auth_1.authenticate,
  (0, authorize_1.authorize)(["SuperAdmin", "AdminRegion"]),
  pointVenteController_1.updatePointVente,
);
