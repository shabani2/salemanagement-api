...
exports.financialSettingsRouter =
  exports.discountRouter =
  exports.exchangeRateRouter =
...
exchangeRateRouter.get(
  "/:baseId/:targetId",
  currencyController_1.getExchangeRate,
);
...
discountRouter.get(
  "/validate/:code",
  currencyController_1.validateDiscountCode,
);
