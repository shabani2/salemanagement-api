...
usersRouter.get("/pointvente/:pointVenteId", auth_1.authenticate, (0, authorize_1.authorize)(["SuperAdmin", "AdminRegion", "AdminPointVente"]), userController_1.getUsersByPointVente);
usersRouter.get("/region/:regionId", auth_1.authenticate, (0, authorize_1.authorize)(["SuperAdmin", "AdminRegion"]), userController_1.getUsersByRegion);
usersRouter.get("/", auth_1.authenticate, (0, authorize_1.authorize)(["SuperAdmin"]), userController_1.getAllUsers);
