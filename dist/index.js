...
app.use(
  "/assets/categorie",
  express_1.default.static(path_1.default.join(__dirname, "assets/categorie")),
);
app.use(
  "/assets/SuperAdmin",
  express_1.default.static(path_1.default.join(__dirname, "assets/SuperAdmin")),
);
app.use(
  "/assets/AdminRegion",
  express_1.default.static(
    path_1.default.join(__dirname, "assets/AdminRegion"),
  ),
);
app.use(
  "/assets/AdminPointVente",
  express_1.default.static(
    path_1.default.join(__dirname, "assets/AdminPointVente"),
  ),
);
app.use(
  "/assets/Vendeur",
  express_1.default.static(path_1.default.join(__dirname, "assets/Vendeur")),
);
app.use(
  "/assets/Client",
  express_1.default.static(path_1.default.join(__dirname, "assets/Client")),
);
app.use(
  "/assets/Logisticien",
  express_1.default.static(
    path_1.default.join(__dirname, "assets/Logisticien"),
  ),
);
app.use(
  "/assets/organisations",
  express_1.default.static(
    path_1.default.join(__dirname, "assets/organisations"),
  ),
);
// Routes principales
